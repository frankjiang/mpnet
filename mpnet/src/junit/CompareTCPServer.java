...
/**
 * The TCP server test case for comparing the multi-socket.
 * <p>
 * </p>
 * 
...
public class CompareTCPServer
{
	...
	public final void test() throws Exception
	{
		...
		SocketType type = SocketType.TCP_SERVER;
		...
		t.close();
		s.close();
		System.out.printf("[TASK] TCP ServerTime = %dms\r\n",
